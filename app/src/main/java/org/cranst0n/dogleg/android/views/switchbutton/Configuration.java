...
/**
 * class for configuring the Switch Button
...
public class Configuration implements Cloneable {
  ...
  static class Default {
    static final int DEFAULT_OFF_COLOR = Color.parseColor("#E3E3E3");
    static final int DEFAULT_ON_COLOR = Color.parseColor("#02BFE7");
    static final int DEFAULT_THUMB_COLOR = Color.parseColor("#FFFFFF");
    static final int DEFAULT_THUMB_PRESSED_COLOR = Color.parseColor("#fafafa");
    static final int DEFAULT_THUMB_MARGIN = 2;
    static final int DEFAULT_RADIUS = 999;
    static final float DEFAULT_MEASURE_FACTOR = 2f;
    static final int DEFAULT_INNER_BOUNDS = 0;
  }
